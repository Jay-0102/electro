    ...
    <div class="row ">
      ...
      <h2>Laptop Details</h2>
        <div class="table-responsive">
          ...
          ?>
              <tr>
              <td><?php echo $row['lp_id']; ?></td>
                <td><?php echo $row['name']; ?></td>
                <td><?php echo $row['model']; ?></td>
                <td><?php echo $row['price']; ?></td>
                <td><?php echo $row['des']; ?></td>
                <td><?php echo $row['img']; ?></td>
                <td><a href="add_laptop.php"="<?php //echo $row['id']; ?>"><i class="fa-regular fa-pen-to-square">Edit</i></a></td>
                <td><a href="add_laptop.php"="<?php //echo $row['id']; ?>">Delete</a></td>
